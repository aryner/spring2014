...
public class SourceReader {
    ...
    private ArrayDeque<String> programLines = new ArrayDeque<String>();
/*
...
/**
 *  prints each line of the program up to and including
 *  any errors found in Lexer.  If no errors are found,
 *  prints every line of the program.
*/
    public void printLines() {
        ...
        while(!programLines.isEmpty()) {
            ...
            System.out.println(number +". " +  programLines.removeFirst());
            number++;
        }
    }
}
